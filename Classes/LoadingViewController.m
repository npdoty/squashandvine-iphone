...
@synthesize timer, loadingImageView;
...
- (void)loadView {
	...
	loadingImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loadingSplash2.png"]];
	loadingImageView.frame = CGRectMake(0, 0, 320, 480);
